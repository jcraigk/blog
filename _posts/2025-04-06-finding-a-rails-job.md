...
My search began in mid January and concluded in early April when I accepted the first offer I received (because it was a good offer and I had only four days to accept it). As you can see in the Sankey diagram above, I applied to a total of 21 organizations. Two of these reached out to me directly on LinkedIn based on my profile having the `#opentowork` tag enabled. The rest I applied to via job listings I saw on [RubyOnRemote](https://rubyonremote.com/) and [HackerNews](https://news.ycombinator.com/).

What surprised me the most about finding a job in 2025 was how slow the process was. My previous experience had been spending no more than four weeks between the time I applied and the time I was given a pass or an offer. I also had gone through no more than four interviews per position. As it turns out, those numbers no longer held. To earn the offer I accepted, I faced nine one-on-one interviews over the course of 10 weeks as well as seven phone conversations with a recruiter. That seemed like a lot to me.
...
The first conversation was with an engineering manager that lasted one hour. The first half focused on my work history and experience and the second half was a light tech screening. The questions covered basic knowledge of topics such as APIs, web hooks, database transactions, rate limiting, etc. The questions were very general and easy to answer, appropriate for a basic screening. I was able to ascertain from the manager that the company consisted of about 10 engineers and 10 other staff and that they were only hiring one or two more engineers at the time and didn't have plans to scale up the team significantly.
